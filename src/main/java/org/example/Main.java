...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Thread herodotus = new Thread(new Philosopher("Kant", 1500, latch), "Herodotus");
        Thread euclid = new Thread(new Philosopher("Plato", 2500, latch), "Euclid");
        Thread pythagoras = new Thread(new Philosopher("Pythagoras", 1000, latch), "Pythagoras");
        Thread socrates = new Thread(new Philosopher("Socrates", 900, latch), "Socrates");
        Thread aristotle = new Thread(new Philosopher("Aristotle", 300, latch), "Aristotle");
